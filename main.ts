...
function _0301 () {
    music.play(music.tonePlayable(311, music.beat(BeatFraction.Whole) + music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
...
function _0201 () {
    music.play(music.tonePlayable(165, music.beat(BeatFraction.Half) + music.beat(BeatFraction.Quarter)), music.PlaybackMode.UntilDone)
...
function _0501 () {
    music.play(music.tonePlayable(220, music.beat(BeatFraction.Whole) + music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(247, music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(277, music.beat(BeatFraction.Whole)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(220, music.beat(BeatFraction.Whole)), music.PlaybackMode.UntilDone)
}
...
function _0402 () {
    music.play(music.tonePlayable(277, music.beat(BeatFraction.Whole) + music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(294, music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
...
function _0502 () {
    music.play(music.tonePlayable(208, music.beat(BeatFraction.Double)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(247, music.beat(BeatFraction.Whole)), music.PlaybackMode.UntilDone)
...
function _0702 () {
    music.play(music.tonePlayable(185, music.beat(BeatFraction.Whole)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(208, music.beat(BeatFraction.Whole) + music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(220, music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(277, music.beat(BeatFraction.Whole)), music.PlaybackMode.UntilDone)
}
function _0801 () {
...
function _0802 () {
    music.play(music.tonePlayable(294, music.beat(BeatFraction.Whole) + music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(247, music.beat(BeatFraction.Half)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(277, music.beat(BeatFraction.Whole)), music.PlaybackMode.UntilDone)
    music.play(music.tonePlayable(220, music.beat(BeatFraction.Whole)), music.PlaybackMode.UntilDone)
}
